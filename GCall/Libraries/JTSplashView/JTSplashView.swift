...
class JTSplashView: UIView {
    ...
    var bgColor = UIColor(red: 82/255, green: 25/255, blue: 126/255, alpha: 1.0)//UIColor(red: 45.0 / 255.0, green: 61.0 / 255.0, blue: 81.0 / 255.0, alpha: 1.0)
    var circleColor = UIColor.whiteColor()//UIColor(red: 110.0 / 255.0, green: 180.0 / 255.0, blue: 240.0 / 255.0, alpha: 1.0)
